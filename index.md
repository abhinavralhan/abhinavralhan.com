...
var page = location.pathname.match(/\/page\/(\d+)/) ? parseInt(RegExp.$1) : 1;
...
document.getElementById('pagination').innerHTML = (page>1?'<a href="'+(page==2?'/':'/page/'+(page-1)+'/')+'">Previous</a>':'<span class="disabled">Previous</span>')+'<span class="page-info">Page '+page+' of '+total+'</span>'+(page<total?'<a href="/page/'+(page+1)+'/">Next</a>':'<span class="disabled">Next</span>');
